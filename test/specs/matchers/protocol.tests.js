...
describe('The protocol matcher', function() {
  ...
  describe('for HTTP servers', function() {
    ...
    it('matches "http"', function(done) {
      var rule = { from: { protocol: 'http' }, to: 'https://otherdomain.com/{url}' };
  ...
  describe('for HTTPS servers', function() {
    ...
    it('matches "https"', function(done) {
      var rule = { from: { protocol: 'https' }, to: '//secure.otherdomain.com/{url}' };
